...
object CONSTANTS {
 ...
 /* val estimated_duration_list = arrayOf(
    ...
    val address_type_category = arrayOf(
        PickUp,
        DropOff
    )
    ...
    const val dropoff = "dropoff"
    const val additional_pickup_loc = "additional_pickup_loc"
    const val additional_dropoff_loc = "additional_dropoff_loc"
    ...
    const val PREFERENCE_ADD_PICK_UP_LATITUDE_EXTRA = "add_pick_up_latitude"
    const val PREFERENCE_ADD_PICK_UP_LONGITUDE_EXTRA = "add_pick_up_longitude"
    ...
    const val additional_estimated_payment = "additional_estimated_payment"
    const val is_flexible = "is_flexible"
    const val date_booking = "date_booking"
    const val additional_pick_data = "additional_pick_data"
